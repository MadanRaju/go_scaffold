...
// func (a *Auth) HasRole(roles inventory-optimisation-server/internal.string) func(next web.Handler) web.Handler {
...
// 			if !claims.HasRole(rolesinventory-optimisation-server/internal.) {
